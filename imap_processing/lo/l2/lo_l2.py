...
def load_sputter_correction_data(
    ...
    """
    Load sputter correction factors from ancillary file.
...
def load_bootstrap_correction_data() -> pd.DataFrame:
    """
    Load bootstrap correction factors from ancillary file.
...
def calculate_bootstrap_corrections(dataset: xr.Dataset) -> xr.Dataset:
    ...
    # Table 3 bootstrap terms h_i,k - load from ancillary file
